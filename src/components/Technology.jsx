...
function Technology(){
    ...
    <div className="relative min-h-screen">
        ...
        <div className= "relative flex-1 flex flex-col  " >
            <Navigation/>
            <main className=" text-white  mx-6 mt-6 mb-12 md:m-[40px]"> 
                ...
                <div className=" w-full flex 2xl:flex-row flex-col  gap-[2rem]  2xl:gap-[2rem]">
                    <div className=" flex-1 gap-[2.5rem]   2xl:gap-[4rem] 2xl:p-0 2xl:flex-row 2xl:w-1/2 order-2
                                    flex flex-col text-center items-center relative  ">
                    <img className="h-auto    object-cover   bg-center bg-no-repeat      
                            left-0  overflow-hidden min-[258px]    min-w-screen 2xl:flex-1 2xl:order-2 
                            2xl:min-w-[608px] 2xl:min-h-[600px] 2xl:py-[67px] 2xl:object-contain"
                    src={windowWidth >= 1440 ? images[technology.name].portrait : images[technology.name].landscape}
                    alt={technology.name}
                    />
                        <div className="order-1  font-bellefair 2xl:m-0   flexCenter flex-row 2xl:flex-col gap-8  text-center text-white">
                        ...
                        <div className="order-1  max-w-md flex flex-col gap-8 font-bellefair">
