...
function Home() {
  ...
  return (
    <div className="min-h-screen text-white flex flex-col overflow-hidden">
      <div className="fixed inset-0 -z-10 bg-cover bg-center bg-no-repeat min-h-screen
      ...
      <main className="flex-1 w-full max-w-[1440px] mx-auto p-6  
            ...
            <div className="text-center  flex-col  gap-4 flex
                 2xl:px-0 2xl:items-start 2xl:justify-start md:px-[5.5rem] md:gap-6 2xl:text-start
                 2xl:w-[540px]">
                <h2 className="text-sm md:text-lg font-barlowC w-full  tracking-[4px]  text-blue-600  ">SO, YOU WANT TO TRAVEL TO</h2>
                <h1 className="text-4xl md:text-6xl font-bellefair w-full "> SPACE </h1>
                <p  className=" text-xs md:text-18 font-barlow text-blue-600 text-center 2xl:m-0 2xl:text-start
                              line-clamp-3 " >
            ...
            <div className="flexCenter flex-1 content-start  flex-col  2xl:items-end! 2xl:px-0  md:px-[5.5rem] ">
              <button className="font-[bellefairRegular] text-18 md:text-2xl size-[150px] 
